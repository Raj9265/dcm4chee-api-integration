...
class QueryServiceImpl implements QueryService {
    ...
    @Override
    public List<String> listDistinctSendingAETs() {
        // JPQL using fully-qualified entity class name (matches what you used earlier)
        return em.createQuery(
                        "SELECT DISTINCT s.sendingAET FROM org.dcm4chee.arc.entity.Series s " +
                                "ORDER BY s.sendingAET",
                        String.class)
                .getResultList();
    }
