...
set MAIN_JAR=dcm4che-tool-probetc-5.34.1.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-api-5.34.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-ldap-5.34.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-prefs-5.34.1.jar
