...
set MAIN_JAR=dcm4che-tool-storescu-5.34.1.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-5.34.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-5.34.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-5.34.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-opencv-5.34.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-rle-5.34.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-common-5.34.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\weasis-core-img-4.11.0.jar
