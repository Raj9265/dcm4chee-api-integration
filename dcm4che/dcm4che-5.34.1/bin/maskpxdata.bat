@echo off
rem -------------------------------------------------------------------------
rem maskpxdata  Launcher
rem -------------------------------------------------------------------------

if not "%ECHO%" == ""  echo %ECHO%
if "%OS%" == "Windows_NT"  setlocal

set MAIN_CLASS=org.dcm4che3.tool.maskpxdata.MaskPxData
set MAIN_JAR=dcm4che-tool-maskpxdata-5.34.1.jar
...
set CP=%DCM4CHE_HOME%\etc\maskpxdata\
